import unittest
from utils import get_current_url, daily_update_url, generate_random_string
...
class TestUtils(unittest.TestCase):
	...
	def test_get_current_url(self):
		if os.getenv('REPLIT_DEPLOYMENT') == '1':
			...
			self.assertNotEqual(real_url, f"{os.environ['TEACHER_URL']}?url_suffix={db.get('url_suffix', '')}")
